...
* 调整 soloncode 日志存放位置，转到 "~/.soloncode/logs/{workspaceLogKey}/" 下面
...
* 添加 soloncode anthropic 上下文缓存显示支持
* 优化 soloncode web 对话切换性能
